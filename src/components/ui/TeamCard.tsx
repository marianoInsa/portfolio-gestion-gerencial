              ...
              <Image
                ...
                onError={(e) => {
                  ...
                  if (parent) {
                    ...
                    fallback.style.cssText = 'width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#EEF2FF,#C7D2FE);font-family:var(--font-heading);font-weight:700;font-size:1.5rem;color:#3730A3;';
                    fallback.textContent = `${member.firstName.charAt(0)}${member.lastName.charAt(0)}`;
                    parent.innerHTML = '';
